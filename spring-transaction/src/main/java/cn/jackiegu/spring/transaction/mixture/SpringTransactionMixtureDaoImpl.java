...
@Repository
public class SpringTransactionMixtureDaoImpl implements SpringTransactionMixtureDao {
    ...
    public void save(SpringTransactionMixtureEntity entity) {
        try {
            ...
            throw new SpringTransactionMixtureException(e);
        }
    }
    ...
    public SpringTransactionMixtureEntity findById(Integer id) {
        ...
        try {
            ...
            while (rs.next()) {
                result = SpringTransactionMixtureEntity.builder()
                    .id(rs.getInt("ID"))
